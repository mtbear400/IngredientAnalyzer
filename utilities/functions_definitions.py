        ...
        for method in methods:
            ...
            function_definition = {
                ...
                "parameters": {
                    ...
                    "requirements_for_response": "Please respond ONLY with valid json that conforms to this pydantic json_schema: {model_class.schema_json()}. Do not include additional text other than the object json as we will load this object with json.loads() and pydantic.",
            ...
            function_definition["parameters"]["properties"]["steps_remaining"] = {
                "type": "string",
                "description": "brief but accurate description of the remaining steps that you have. 'all steps completed' if you are done"
            }
